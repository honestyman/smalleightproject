  ...
  return (
    <div className='w-full bg-[#f4f8f9] pt-20'>
      <div className='w-full [#f4f8f9] rounded-[100px] sp:rounded-[20px] flex flex-col justify-center items-center px-10 pb-10 sp:px-5'>
        <h1 className='text-4xl font-bold mt-20 text-[#B40100] sp:text-2xl sp:mb-5'>プライバシーポリシー</h1>
        <div className='w-full rounded-md px-10 py-20 leading-loose tracking-wider sp:py-5 sp:px-5'>
          ...
          <div className='text-left py-5 sp:py-2'>
            <h2 className='text-xl font-bold my-2 sp:text-xl'>個人情報</h2>
          ...
          <div className='text-left py-5 sp:py-2'>
            <h2 className='text-xl font-bold my-2 sp:text-xl'>個人情報の収集方法</h2>
          ...
          <div className='text-left py-5 sp:py-2'>
            <h2 className='text-xl font-bold my-2 sp:text-xl'>個人情報を収集・利用する目的</h2>
          ...
          <div className='text-left py-5 sp:py-2'>
            <h2 className='text-xl font-bold my-2 sp:text-xl'>利用目的の変更</h2>
          ...
          <div className='text-left py-5 sp:py-2'>
            <h2 className='text-xl font-bold my-2 sp:text-xl'>免責事項</h2>
          ...
          <div className='text-left py-5 sp:py-2'>
            <h2 className='text-xl font-bold my-2 sp:text-xl'>広告について</h2>
          ...
          <div className='text-left py-5 sp:py-2'>
            <h2 className='text-xl font-bold my-2 sp:text-xl'>アクセス解析ツールについて</h2>
