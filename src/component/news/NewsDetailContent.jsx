  ...
  return (
    <div className='w-full bg-white to-red-700 pt-20 pb-20'>
      <div className='w-full bg-white'>
        <p className='pt-10 ml-40 text-left'><Link to="/" className='bg-[#191F4D] py-1 px-2 rounded text-white'>Top</Link> / <Link className='bg-[#191F4D] py-1 px-2 rounded text-white' to="/news">ニュース</Link> / {oneNewsData.title}</p>
        <div className='w-full flex justify-center pb-10 sp:rounded-[20px] sp:flex-wrap-reverse'>
          <div className='w-[75%] flex flex-col px-20 text-left sp:px-5 sp:w-full'>
            <div className='flex py-10 flex justify-between items-center flex-wrap'>
              <p className='text-xl text-[#191F4D] font-bold mx-5 sp:text-sm'>{oneNewsData.publishDate ? oneNewsData.publishDate.slice(0, 10) : ""}</p>
            </div>
            ...
            <p className='my-10 sp:text-sm'>{oneNewsData.contents}</p>
